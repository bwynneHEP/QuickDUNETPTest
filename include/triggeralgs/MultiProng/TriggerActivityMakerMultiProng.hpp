/**
 * @file TriggerActivityMakerMultiProng.hpp
 *
...
#ifndef TRIGGERALGS_MULTIPRONG_TRIGGERACTIVITYMAKERMULTIPRONG_HPP_
#define TRIGGERALGS_MULTIPRONG_TRIGGERACTIVITYMAKERMULTIPRONG_HPP_
...
class TriggerActivityMakerMultiProng : public TriggerActivityMaker
{
...
private:
  ...
  timestamp_t m_window_length = 10000;   // Roughly the drift time of the VDCB, which is what the 'visual
                                         // field' should be set to for an activity finder.
...
#endif // TRIGGERALGS_MULTIPRONG_TRIGGERACTIVITYMAKERMULTIPRONG_HPP_
